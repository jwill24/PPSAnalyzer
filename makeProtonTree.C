...
void makeProtonTree( TString outFile=output_file )
{
  ...
  TChain chain("Events");
  chain.Add( "Skims/nanoAOD_Run2017B_Skim.root" );
  chain.Add( "Skims/nanoAOD_Run2017C_Skim.root" );
  chain.Add( "Skims/nanoAOD_Run2017D_Skim.root" );
  ...
  chain.SetBranchAddress( "LHCInfo_xangle", &xangle );
  ...
  for ( unsigned int i=0; i<entries; i++ ) { // Loop over entries
    ...
    // Fill tree based on era and xangle
    if ( run > 297023 && run < 299330 ) { // Run2017B
      if ( xangle == 120 ) tree_B_120->Fill();
      else if ( xangle == 130 ) tree_B_130->Fill();
      else if ( xangle == 140 ) tree_B_140->Fill();
      else if ( xangle == 150 ) tree_B_150->Fill();
    } else if ( run > 299359 && run < 302045 ) { // Run2017C
      if ( xangle == 120 ) tree_C_120->Fill();
      else if ( xangle == 130 ) tree_C_130->Fill();
      else if ( xangle == 140 ) tree_C_140->Fill();
      else if ( xangle == 150 ) tree_C_150->Fill();
    } else if ( run > 302111 && run < 302679 ) { // Run2017D
      if ( xangle == 120 ) tree_D_120->Fill();
      else if ( xangle == 130 ) tree_D_130->Fill();
      else if ( xangle == 140 ) tree_D_140->Fill();
      else if ( xangle == 150 ) tree_D_150->Fill();
    } else if ( run > 303708 && run < 304798 ) { // Run2017E
      if ( xangle == 120 ) tree_E_120->Fill();
      else if ( xangle == 130 ) tree_E_130->Fill();
      else if ( xangle == 140 ) tree_E_140->Fill();
      else if ( xangle == 150 ) tree_E_150->Fill();
    } else if ( run > 305016 && run < 306463 ) { // Run2017F
      if ( xangle == 120 ) tree_F_120->Fill();
      else if ( xangle == 130 ) tree_F_130->Fill();
      else if ( xangle == 140 ) tree_F_140->Fill();
      else if ( xangle == 150 ) tree_F_150->Fill();
    }

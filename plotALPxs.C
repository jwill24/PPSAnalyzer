...
void plotALPxs()
{
  ...
  std::vector<sample_t> samples = {
    ...
    {0.0125, 500,  6.637e-6}, // AAF0 = 80,000
    {0.0125, 750,  1.661e-5},
    {0.0125, 1000, 1.714e-5},
    {0.0125, 1250, 9.725e-6},
    {0.0125, 1500, 5.051e-6},
    {0.0125, 2000, 9.981e-7},
  ...
  // post preapproval corrections - with shapes
  //std::vector<float> observed =  {0.1525, 0.0822, 0.0873, 0.2464, 0.2168, 9.9267};
  //std::vector<float> two_minus = {0.0538, 0.0324, 0.0347, 0.0503, 0.0747, 2.0770}; 
  //std::vector<float> one_minus = {0.0900, 0.0521, 0.0557, 0.0823, 0.1246, 3.4976};
  //std::vector<float> limit =     {0.1641, 0.0923, 0.0986, 0.1479, 0.2305, 6.4062};
  //std::vector<float> one_plus =  {0.3066, 0.1695, 0.1804, 0.2742, 0.4344, 11.9730};
  //std::vector<float> two_plus =  {0.4974, 0.2798, 0.2990, 0.4485, 0.6987, 19.4218};

  // post preapproval corrections - cut and count
  std::vector<float> observed =  {0.2600, 0.1359, 0.1437, 0.2256, 0.3710, 9.4178}; 
  std::vector<float> two_minus = {0.1177, 0.0614, 0.0650, 0.1020, 0.1677, 4.2682}; 
  std::vector<float> one_minus = {0.1718, 0.0896, 0.0948, 0.1489, 0.2447, 6.2283};
  std::vector<float> limit =     {0.2715, 0.1416, 0.1499, 0.2354, 0.3867, 9.8438};
  std::vector<float> one_plus =  {0.4468, 0.2330, 0.2467, 0.3873, 0.6364, 16.2002};
  std::vector<float> two_plus =  {0.7161, 0.3735, 0.3954, 0.6208, 1.0200, 25.9637};

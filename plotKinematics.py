...
aqgc = ['outputHists/histOut_aqgc_'+selection+'_2017.root',3.86e-4,300000,92] # xs * 10
...
def plotRatio(name, h1, v_hist, hs, log):
    ...
    l2.SetLineStyle(3), l3.SetLineStyle(3)
    l1.Draw(), l2.Draw(), l3.Draw()

    Prettify( h_ratio )

    c.SaveAs(name+'_'+selection+'.png')
...
def makeLegend(h1,v_hist,hs):
    ...
    legend.AddEntry(hs,'AQGC #times 10','l')
    return legend
...
h_aqgc_diph_mass.SetFillColor(0)
...
h_aqgc_single_pt.SetFillColor(0)
...
h_aqgc_single_eta.SetFillColor(0)
